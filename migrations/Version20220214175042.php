 ...
 */
final class Version20220214175042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE ban_period ban_period DATE DEFAULT NULL');
    }
