 ...
 */
final class Version20220310015236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE newsletter ADD image_f VARCHAR(255) NOT NULL, ADD title_s VARCHAR(255) NOT NULL, ADD content_s LONGTEXT NOT NULL, ADD image_s VARCHAR(255) NOT NULL, ADD title_t VARCHAR(255) NOT NULL, ADD content_t LONGTEXT NOT NULL, ADD image_t VARCHAR(255) NOT NULL, ADD title_intro VARCHAR(255) NOT NULL, ADD content_intro VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE newsletter DROP image_f, DROP title_s, DROP content_s, DROP image_s, DROP title_t, DROP content_t, DROP image_t, DROP title_intro, DROP content_intro, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
