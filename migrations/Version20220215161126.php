 ...
 */
final class Version20220215161126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD rating DOUBLE PRECISION DEFAULT NULL, CHANGE description description VARCHAR(255) NOT NULL');
    }
