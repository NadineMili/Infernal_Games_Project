 ...
 */
final class Version20220301153034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stream_comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, stream_id INT DEFAULT NULL, text VARCHAR(255) NOT NULL, time_stamp DATETIME NOT NULL, INDEX IDX_C21DB99FA76ED395 (user_id), INDEX IDX_C21DB99FD0ED463E (stream_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE stream_comment ADD CONSTRAINT FK_C21DB99FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE stream_comment ADD CONSTRAINT FK_C21DB99FD0ED463E FOREIGN KEY (stream_id) REFERENCES stream (id)');
    }
