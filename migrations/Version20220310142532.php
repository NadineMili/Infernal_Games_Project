 ...
 */
final class Version20220310142532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating ADD user_id INT DEFAULT NULL, ADD game_id INT DEFAULT NULL, CHANGE rate_index user_rating INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D8892622E48FD905 ON rating');
        $this->addSql('ALTER TABLE rating DROP user_id, DROP game_id, CHANGE user_rating rate_index INT NOT NULL');
    }
}
