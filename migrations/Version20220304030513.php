 ...
 */
final class Version20220304030513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stream_comment CHANGE time_stamp time_stamp DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stream_comment CHANGE text text VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE time_stamp time_stamp DATETIME DEFAULT CURRENT_TIMESTAMP');
