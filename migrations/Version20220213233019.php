 ...
 */
final class Version20220213233019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE newsletter ADD author_id INT NOT NULL, ADD date DATE NOT NULL');
        $this->addSql('ALTER TABLE newsletter ADD CONSTRAINT FK_7E8585C8F675F31B FOREIGN KEY (author_id) REFERENCES admin (id)');
        $this->addSql('CREATE INDEX IDX_7E8585C8F675F31B ON newsletter (author_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7E8585C8F675F31B ON newsletter');
        $this->addSql('ALTER TABLE newsletter DROP author_id, DROP date, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
